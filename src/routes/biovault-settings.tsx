...
const BioVaultSettingsView = React.lazy(() => import('../components/Views/BioVaultSettingsView'));

function BioVaultSettingsPage() {
  return (
...
export const Route = createFileRoute('/biovault-settings')({
  component: BioVaultSettingsPage,
});
